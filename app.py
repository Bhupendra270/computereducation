...
COURSES = [
...

    {
        ...
        "color": "orange",
        "description":
            "Learn internet basics, web browsing, email, "
...
def quiz(course_id):
    ...
    questions = [
        ...
        if question.get("course_id") == course_id
